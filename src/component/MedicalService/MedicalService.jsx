        ...
        <div>
            ...
            <div className="flex justify-center gap-5 flex-wrap my-5">
                <div className="shadow p-5 rounded w-[250px] !bg-[#FFFFFF]">
                    ...
                    <h1 className='text-5xl my-5 !text-black'> {doctorCount} +</h1>
                    <p>Total Doctors</p>
                </div>
                <div className="shadow p-5 rounded w-[250px] !bg-[#FFFFFF]">
                    <div className="">
                    ...
                    <h1 className='text-5xl my-5 !text-black'> {patientsCount} +</h1>
                    <p>Total Patients</p>
                </div>
                <div className="shadow p-5 rounded w-[250px] !bg-[#FFFFFF]">
                    <div className="">
                    ...
                    <h1 className='text-5xl my-5 !text-black'> {reviewCount} +</h1>
                    <p>Total Review</p>
                </div>
                <div className="shadow p-5 rounded w-[250px] !bg-[#FFFFFF]">
                    <div className="">
                    ...
                    <h1 className='text-5xl my-5 !text-black'> {staffsCount} +</h1>
                    <p>Total Staffs</p>
                </div>
            </div>
        </div>
