    ...
    return (
        <div>
            ...
            <div className="flex justify-center my-5">
                <div className="w-[80%]">
                    <h1 className='text-2xl md:text-5xl text-center !text-black md:leading-[3.5rem]'>My Appointments</h1>
                    <p className="!text-gray-500 text-center my-5">Our platform connects you with verified. exprenced doctors across vairous specialties -- all your convenience.</p>
                </div>
            </div>
